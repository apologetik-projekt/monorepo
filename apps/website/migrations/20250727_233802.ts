...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "posts" (
  	...
  	"description" varchar,
  	"content" jsonb,
  	"appendix" jsonb DEFAULT '{"root":{"type":"root","children":[{"tag":"h2","type":"heading","children":[{"text":"Quellen","type":"text"}]}]}}',
  	"meta_title" varchar,
  	"meta_description" varchar,
  	"meta_image_id" integer,
  	"author_id" integer,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_content" jsonb,
  	"version_appendix" jsonb DEFAULT '{"root":{"type":"root","children":[{"tag":"h2","type":"heading","children":[{"text":"Quellen","type":"text"}]}]}}',
  	"version_meta_title" varchar,
  	"version_meta_description" varchar,
  	"version_meta_image_id" integer,
  ...
  CREATE TABLE "navigation_nav_items_nested_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "navigation_nav_items_nested_nav_items_order_idx" ON "navigation_nav_items_nested_nav_items" USING btree ("_order");
  CREATE INDEX "navigation_nav_items_nested_nav_items_parent_id_idx" ON "navigation_nav_items_nested_nav_items" USING btree ("_parent_id");
  ...
  CREATE INDEX "navigation_rels_media_id_idx" ON "navigation_rels" USING btree ("media_id");`)
}
